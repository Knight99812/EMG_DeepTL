...
path_data = 'F:\Data\V2\';
save_path1 = 'E:\EMG_DeepTL\data\V2\feature_all\';
save_path2 = 'E:\EMG_DeepTL\data\V2\label\';
...
for i = 21:41
    for j = 1:2
        load([path_data,num2str(i),'_',num2str(j),'.mat']);
        Ntrial = 60 - min(abs(find(motionLabel==10)-60));
        label = (motionLabel(1:Ntrial)-1)';
        data = motionData(1:Ntrial);
        feature = [];
        ...
        save([save_path1,num2str(i),'_',num2str(j),'.mat'],'feature');
        save([save_path2,num2str(i),'_',num2str(j),'.mat'],'label');
    end
end
