...
for i = 1:41
    ...
    load([data_path,'feature\',num2str(i),'_1.mat'])
    load([data_path,'label\',num2str(i),'_1.mat'])
    feature_target = zeros(size(feature,1),1024);
    label_target = label;
    for p = 1:size(feature,1)
        temp1 = feature(p,1,:,:);
        temp2 = feature(p,2,:,:);
    ...
    [target_xt,~,~] = standardization(feature_target);
    target_yt = label_target;

    load([data_path,'feature\',num2str(i),'_2.mat'])
    load([data_path,'label\',num2str(i),'_2.mat'])
